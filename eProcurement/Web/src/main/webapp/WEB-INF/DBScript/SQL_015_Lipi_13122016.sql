...
/*Data for the table `tbl_tenderformula` */

insert  into `tbl_tenderformula`(`cellId`,`cellNo`,`colFormula`,`columnNo`,`displayFormula`,`formula`,`formulaId`,`formulaType`,`columnId`,`formId`,`tableId`,`validationMessage`) values (124,1,'',22,'','',1,1,24,13,18,NULL),(118,2,'',2,'','',2,0,28,14,19,'');
