							...
							<div class="row">
								...
								<div class="col-lg-12 col-md-12 col-xs-12">
									...
									<div class="row">
										...
										<div class="fr-grp">
										<label class="lblfr-fields"><spring:message code="lbl_link_name"/></label>
										<form:input class="form-control fr-cntrl" id="linkName" path="linkName" validarr="required@@tenderbrief:50" tovalid="true" onblur="validateTextComponent(this)" title="Link name" ></form:input>
										<form:hidden  id="hdLinkId" path="linkId" ></form:hidden>
										</div>
										
										<div class="fr-grp">
										<label class="lblfr-fields"><spring:message code="lbl_link"/></label>
										<form:input class="form-control fr-cntrl" id="link" path="link" validarr="required@@tenderbrief:50" tovalid="true" onblur="javascript:{if(validateCombo(this)){searchAjax();}}" title="Link" ></form:input>
										...
										<div class="fr-grp">
										<label class="lblfr-fields"><spring:message code="lbl_link_module"/></label>
										<form:input class="form-control fr-cntrl" id="module" path="module" validarr="required@@tenderbrief:10" tovalid="true" onblur="validateTextComponent(this)" title="Module" ></form:input>
										</div>
										
										<div class="fr-grp">
										<label class="lblfr-fields"><spring:message code="lbl_link_desc"/></label>
										<form:textarea class="form-control fr-cntrl" id="description" path="description" validarr="required@@length:0,500" tovalid="true" onblur="validateTextComponent(this)" validationmsg="Allows Max. 500 alphabets, numbers and special characters" title="description"></form:textarea>
										</div>
