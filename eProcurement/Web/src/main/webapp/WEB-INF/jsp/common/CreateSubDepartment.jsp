            ...
            function validate(){
            	...
            	if(vbool){
            		if($("#parentDeptId").val()!="0"){
            			...
            			vbool=false;
            			$('#deptLocation').html("Please select Location/department").show();
            		}
            	}
...
<div class="row">
								...
								<div class="col-lg-12 col-md-12 col-xs-12">
									...
									<div class="row">
										...
										<c:if test="${sessionObject.isOrgenizationUser eq 1}">
												<select class="form-control" name="grandParentDeptId"  id="grandParentDeptId" isrequired="true" onblur="javascript:{if(validateCombo(this)){getSubDepartmentsByGrandDepartment()}}" title="Organization" >
									...
									<div class="row">
										...
										<div class="col-lg-5">
											<form:select class="form-control" path="parentDeptId" id="parentDeptId" isrequired="true" onchange="validateCombo(this)"  title="Location/Department"  items="${parentDeptLst}"></form:select>
											<div id="deptLocation" style="color: red;display: none;"></div>
										</div>
									</div>
									<div class="row">
										<div class="col-lg-2">
											<div class="form_filed">Sub department name :</div>
										</div>
										<div class="col-lg-5">
				...
				<c:if test="${sessionObject.isOrgenizationUser eq 0}">
					<input type="hidden" value="${tblGrandParentDept.deptId}" class="searchEqual" columnName="grandParentDeptId" name="grandParentDeptId">
...
function callActionItem(cthis){
	...
	if(actionname.toLowerCase() == "edit"){
		...
		window.location = "${pageContext.servletContext.contextPath}/common/user/geteditdepartment/"+deptId;
	}
