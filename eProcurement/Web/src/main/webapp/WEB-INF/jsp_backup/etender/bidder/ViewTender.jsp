...
<%@include file="../../includes/leftaccordion.jsp"%>
		...
		<c:if test="${1 ne fromPublishTender && 2 ne fromPublishTender}">
			...
			<c:choose>
				...
				<c:when test="${1 ne fromPublishTender && 2 ne fromPublishTender}">
					...
					<a href="${pageContext.servletContext.contextPath}/etender/bidder/bidderTenderListing/0" class="btn btn-submit pull-right" style="margin-top:0px;"><< Go To Tender Listing</a>			
				</c:when>
				...
				<c:otherwise>
					...
					<c:choose>
						<c:when test="${2 ne fromPublishTender}">
							...
							class="btn btn-submit pull-right" style="margin-top:0px;"><< <spring:message code="lbl_back_dashboard" /></a>
						</c:when>
						<c:when test="${2 eq fromPublishTender}">
							<a href="${pageContext.servletContext.contextPath}/login" class="btn btn-submit pull-right" style="margin-top:0px;"><< Go Back To Login</a>
						</c:when>
					</c:choose>
				</c:otherwise>
			...
			<section class="content">
				<div class="row">
					...
					<tr>
						<td width="29%" class="black"><spring:message
								code="label_tender_department" /></td>
						<td width="1%"><b>:<b>
						</td>
						<td width="20%">${departmentName}</td>
						<td width="29%" class="black"><spring:message
								code="fields_tender_departmentofficial" />
						</td>
						<td width="1%"><b>:<b>
						</td>
					...
					<tr>
						<td width="29%" class="black"><spring:message
								code="fields_tenderid" />
						</td>
						<td width="1%"><b>:<b>
						</td>
						<td width="20%">${tblTender.tenderId}</td>
						<td width="29%" class="black"><spring:message
								code="fields_refenceno" />
						</td>
						<td width="1%"><b>:<b>
						</td>
					...
					<tr>
						<td width="29%" class="black"><spring:message
								code="field_eventtype" />
						</td>
						<td width="1%"><b>:<b>
						</td>
						<td colspan="4" class="event-dtl"><p>${eventTypeName}</p>
						</td>
					</tr>
					<tr>
						<td width="29%" class="black"><spring:message
						...
						<td colspan="4" class="event-dtl"><p>${tblTender.tenderBrief}</p>
						</td>
					</tr>
					<tr>
						<td width="29%"
							class="black border-top-none border-bottom-none v-a-top"><spring:message
								code="field_tender_detail" /></td>
						<td width="1%" class=""><b>:</b>
						</td>
						<td colspan="4" width="70%"
							class="v-a-top table-border table-border-right border-top-none border-bottom-none"
							id="tenderDetailDivTd">
							<div class="event-dtl word-break">
								${tblTender.tenderDetail}</div></td>
					</tr>
					<c:if
						test="${eventTypeId ne null && isCategoryAllow ne null && isCategoryAllow eq 1}">
						<tr>
							<td width="29%" class="black"><spring:message
									code="lbl_auction_category" /></td>
							<td width="1%"><b>:<b>
							</td>
					...
					<tr>
						<td width="29%" style="word-break: break-word" class="black"><spring:message
								code="fields_tender_keywords" />
						</td>
						<td width="1%"><b>:<b>
						</td>
						<td colspan="4" width="29%" class="word-break line-height">${tblTender.keywordText}</td>
						<%-- Changes Bug Id:#26911 --%>
					</tr>
					<%-- </c:if> --%>
            ...
            <td width="20%">
                ${tblTender.validityPeriod}
					...
					<tr>
						...
						<c:set var="cntTd" value="${cntTd+1}" />
						<td width="29%" class="black"><spring:message
								code="lbl_projectduration" />
						</td>
						<td width="1%"><b>:<b>
						</td>
						<td width="20%" class="word-break">
							${tblTender.projectDuration}</td>
						<%--
           <c:if test="${cntTd eq 2}">
           </tr>
           <tr>
 ...
 --%>
						<c:if
							test="${not empty sessionObject and sessionObject ne null and ( sessionObject.userTypeId eq 1 or sessionObject.userTypeId eq 3)}">
							<c:if test="${cntTd eq 2}">
					</tr>
					<tr>
						<c:set var="cntTd" value="0" />
						...
						<c:set var="cntTd" value="${cntTd+1}" />
						<td width="29%" class="black"><spring:message
								code="lbl_tender_value" />
						</td>
						<td width="1%"><b>:<b>
						</td>
						<td width="20%">${tblTender.tenderValue}</td>
						</c:if>
						<%--PT:20193 --%>
					...
					<tr>
						...
						<c:set var="cntTd" value="${cntTd+1}" />
						<td width="29%" class="black"><spring:message
								code="fields_tenderdigital_certrequired" /></td>
						<td width="1%"><b>:</b>
						</td>
						<td width="20%"><c:choose>
					...
					<tr>
						...
						<td width="20%"><c:set var="isSplitPOAllowed"
								value="${valueMap.isSplitPOAllowed}" /> <c:choose>
								<c:when
									test="${isSplitPOAllowed[tblTender.isSplitPOAllowed] eq dontAllow}">
                        ${notallow}
                    </c:when>
								<c:otherwise>
									<c:choose>
										<c:when
											test="${isSplitPOAllowed[tblTender.isSplitPOAllowed] eq allow}">
                                ${allowed}
                            </c:when>
										<c:otherwise>
											<c:out
												value="${isSplitPOAllowed[tblTender.isSplitPOAllowed]}" />
										</c:otherwise>
									</c:choose>
								</c:otherwise>
							</c:choose></td>
					...
					<tr>
						...
						<c:set var="cntTd" value="${cntTd+1}" />
						<td width="29%" class="black"><spring:message
								code="lbl_mode_of_submission" /></td>
						<td width="1%"><b>:<b>
						</td>
						<td width="20%"><c:choose>
					...
					<tr>
						...
						<c:set var="cntTd" value="${cntTd+1}" />
						<td width="29%" class="black"><spring:message
								code="fields_basecurrency" />
						</td>
						<td width="1%"><b>:<b>
						</td>
						<td width="20%">${currencyName}</td>
						<c:if test="${cntTd eq 2}">
					</tr>
					<tr>
						<c:set var="cntTd" value="0" />
						...
						<c:set var="cntTd" value="${cntTd+1}" />
						<td width="29%" class="black"><spring:message
								code="lbl_biddingType" />
						</td>
						<td width="1%"><b>:<b>
						</td>
						<td width="20%"><c:if test="${tblTender.biddingType eq 1}">
								<spring:message code="lbl_national_competitive_bidding" />
							</c:if> <c:if test="${tblTender.biddingType eq 2}">
					...
					<tr>
						...
						<c:set var="cntTd" value="${cntTd+1}" />
						<td width="29%" class="black"><spring:message
								code="lbl_consortium" /></td>
						<td width="1%"><b>:<b>
						</td>
						<td width="20%"><c:set var="isConsortiumAllowed"
								value="${valueMap.isConsortiumAllowed}" /> <c:choose>
							...
							<div class="box-header with-border">
								...
								<div class="box-body">
									<div class="row">
										<div class="col-md-12">
					<table width="100%" cellpadding="0" cellspacing="0"
					class="formField1" id="tldKeyConfDtl">
					<tr>
                ...
                <td width="20%">
					...
					<tr>
						...
						<c:set var="cntTd" value="${cntTd+1}" />
						<td width="29%" class="black"><spring:message
								code="lbl_prebid_address" />
						</td>
						<td width="1%"><b>:<b>
						</td>
						<td width="20%">${tblTender.preBidAddress}</td>
						</c:if>
						<%--                     End --%>
                ...
                <c:if test="${configParam.preBidAddress ne null}">
					...
					<tr>
						...
						<td width="20%">${tblTender.documentSubmission}</td>
						</c:if>
						</c:if>
						<c:set value="${keyConf+1}" var="keyConf" />
						<c:if test="${cntTd eq 2}">
            ...
            <c:set var="cntTd" value="0"/>  
				...
				<c:if test="${2 eq fromPublishTender or 0 eq fromPublishTender}">
					...
					<div class="col-md-12">
						...
						<tr>
							...
							<c:set var="cntTd" value="${cntTd+1}" />
							<td width="29%" class="black"><spring:message
									code="lbl_document_start_date" />
							</td>
							<td width="1%"><b>:<b>
							</td>
							<td width="20%">${documentStartDate}</td>
							<c:if test="${cntTd eq 2}">
						</tr>
						<tr>
							<c:set var="cntTd" value="0" />
							...
							<c:set var="cntTd" value="${cntTd+1}" />
							<td width="29%" class="black"><spring:message
									code="lbl_document_end_date" />
							</td>
							<td width="1%"><b>:<b>
							</td>
							<td width="20%">${documentEndDate}</td>
							<c:if test="${cntTd eq 2}">
						</tr>
						<tr>
							<c:set var="cntTd" value="0" />
							...
							<c:set var="cntTd" value="${cntTd+1}" />
							<td width="29%" class="black"><spring:message
									code="lbl_bid_submission_start_date" />
							</td>
							<td width="1%"><b>:<b>
							</td>
							<td width="20%">${submissionStartDate}</td>
						...
						<tr>
							...
							<c:set var="cntTd" value="${cntTd+1}" />
							<td width="29%" class="black"><spring:message
									code="lbl_bid_submission_end_date" />
							</td>
							<td width="1%"><b>:<b>
							</td>
							<td width="20%">${submissionEndDate}</td>
						...
						<tr>
							...
							<c:set var="cntTd" value="${cntTd+1}" />
							<td width="29%" class="black"><spring:message
									code="fields_prebidmeet_startdate" />
							</td>
							<td width="1%"><b>:<b>
							</td>
							<td width="20%">${preBidStartDate}</td>
							</c:if>
							<c:if test="${tblTender.isPreBidMeeting eq 1}">
								<c:if test="${cntTd eq 2}">
						</tr>
						<tr>
							...
							<c:set var="cntTd" value="${cntTd+1}" />
							<td width="29%" class="black"><spring:message
									code="fields_prebidmeet_enddate" />
							</td>
							<td width="1%"><b>:<b>
							</td>
							<td width="20%">${preBidEndDate}</td>
							</c:if>
							<c:if test="${cntTd eq 2}">
						</tr>
						<tr>
							...
							<c:set var="cntTd" value="${cntTd+1}" />
							<td width="29%" class="black"><spring:message
									code="field_bidopeningstartdate" />
							</td>
							<td width="1%"><b>:<b>
							</td>
							<td width="20%">${openingDate}</td>
						...
						<tr>
							...
							<c:set var="cntTd" value="${cntTd+1}" />
							<td width="29%" class="black"><spring:message
									code="field_queans_startdate" />
							</td>
							<td width="1%"><b>:<b>
							</td>
							<td width="20%">${questionAnswerStartDate}</td>
							<c:if test="${cntTd eq 2}">
						</tr>
						<tr>
							<c:set var="cntTd" value="0" />
							...
							<c:set var="cntTd" value="${cntTd+1}" />
							<td width="29%" class="black"><spring:message
									code="field_queans_enddate" />
							</td>
							<td width="1%"><b>:<b>
							</td>
							<td width="20%">${questionAnswerEndDate}</td>
							</c:if>
							<c:if test="${cntTd eq 0}">
								<td colspan="4"></td>
								<c:set var="cntTd" value="0" />
				...
				<c:set value="0" var="varFeesDtlCnt" />
					...
					<tr>
						...
						<c:set var="cntTd" value="${cntTd+1}" />
						<td width="29%" class="black"><spring:message
								code="fields_fees_amt" />
						</td>
						<td width="1%"><b>:<b>
						</td>
						<td width="20%"><fmt:formatNumber type="number"
								groupingUsed="false" minFractionDigits="2" maxFractionDigits="2"
								value="${tblTender.documentFee}" var="documentFees" />
							${documentFees}</td>
						</c:if>
						<c:if
							test="${(tblTender.isDocfeesApplicable eq 1 or tblTender.isDocfeesApplicable eq 2) and tblTender.docFeePaymentMode eq 2}">
							<c:set value="${varFeesDtlCnt+1}" var="varFeesDtlCnt" />
							<c:if test="${cntTd eq 2}">
					</tr>
					<tr>
						...
						<c:set var="cntTd" value="${cntTd+1}" />
						<td width="29%" class="black"><spring:message
								code="field_docfees_payableat" />
						</td>
						<td width="1%"><b>:<b>
						</td>
						<td width="20%">${tblTender.docFeePaymentAddress}</td>
						</c:if>
						<c:set value="${varFeesDtlCnt+1}" var="varFeesDtlCnt" />
						<c:if test="${cntTd eq 2}">
					</tr>
					...
					<tr>
						...
						<c:set var="cntTd" value="${cntTd+1}" />
						<td width="29%" class="black"><spring:message
								code="field_tendersec_fees_amt" />
						</td>
						<td width="1%"><b>:<b>
						</td>
						<td width="20%"><fmt:formatNumber type="number"
								groupingUsed="false" minFractionDigits="2" maxFractionDigits="2"
								value="${tblTender.securityFee}" var="securityFees" />
							${securityFees}</td>
						</c:if>
						<c:if
							test="${tblTender.isSecurityfeesApplicable eq 1 and tblTender.secFeePaymentMode eq 2}">
							<c:set value="${varFeesDtlCnt+1}" var="varFeesDtlCnt" />
							<c:if test="${cntTd eq 2}">
					</tr>
					<tr>
						...
						<c:set var="cntTd" value="${cntTd+1}" />
						<td width="29%" class="black"><spring:message
								code="field_tendersec_fee_payment_at" />
						</td>
						<td width="1%"><b>:<b>
						</td>
						<td width="20%">${tblTender.secFeePaymentAddress}</td>
						</c:if>
						<c:set value="${varFeesDtlCnt+1}" var="varFeesDtlCnt" />
						<c:if test="${cntTd eq 2}">
					</tr>
					...
					<tr>
						...
						<td width="20%"><fmt:formatNumber type="number"
								groupingUsed="false" minFractionDigits="2" maxFractionDigits="2"
								value="${tblTender.emdAmount}" var="emdAmounts" /> ${emdAmounts}
						</td>
						</c:if>
						<c:if
							test="${(tblTender.isEMDApplicable eq 1 or tblTender.isEMDApplicable eq 2) and tblTender.emdPaymentMode eq 2}">
							<c:set value="${varFeesDtlCnt+1}" var="varFeesDtlCnt" />
							<c:if test="${cntTd eq 2}">
					</tr>
					<tr>
						...
						<c:set var="cntTd" value="${cntTd+1}" />
						<td width="29%" class="black"><spring:message
								code="field_emdpaymentat" />
						</td>
						<td width="1%"><b>:<b>
						</td>
						<td width="20%">${tblTender.emdPaymentAddress}</td>
						</c:if>
					...
					<tr>
						...
						<td width="20%"><c:set var="emdPaymentMode"
								value="${valueMap.isRegistrationCharges}" /> <c:choose>
								<c:when
									test="${isEMDApplicable[tblTender.isRegistrationCharges] eq dontAllow}">
                            ${dontAllow}
                        </c:when>
								<c:otherwise>
									<c:out
										value="${isEMDApplicable[tblTender.isRegistrationCharges]}" />
								</c:otherwise>
							</c:choose></td>
						</c:if>
						<c:if
							test="${not empty configParam.registrationChargesMode && (tblTender.isRegistrationCharges eq 1 or  tblTender.isRegistrationCharges eq 2)}">
							<c:set value="${varFeesDtlCnt+1}" var="varFeesDtlCnt" />
							<c:if test="${cntTd eq 2}">
					</tr>
					<tr>
						...
						<td width="20%"><c:set var="emdPaymentMode"
								value="${valueMap.registrationChargesMode}" /> <c:out
								value="${emdPaymentMode[tblTender.registrationChargesMode]}" />
						</td>
						</c:if>
					...
					<tr>
						...
						<c:set var="cntTd" value="${cntTd+1}" />
						<spring:message code="lbl_tender_registration_charges"
							var="varlblaucregistrationcharges" />
						<td width="29%" class="black">${varlblaucregistrationcharges}</td>
						<td width="1%"><b>:<b>
						</td>
						<td width="20%"><fmt:formatNumber var="regAmounts"
								groupingUsed="false" type="number" maxFractionDigits="2"
								minFractionDigits="2" value="${tblTender.registrationCharges}" />
							${regAmounts}</td>
						</c:if>
							...
							<div class="box-body">
								<div class="row">
									...
									<div class="col-md-12">
										<c:if test="${1 ne fromPublishTender && 2 ne fromPublishTender}">
					<div class="">
						<input type="button" class="btn noExport pdf-bt" onclick="exportContent('viewTenderId','ViewTender',0)" value="PDF"> 
						<input type="button" class="btn noExport print-bt" onclick="exportContent('viewTenderId','PendingTender',5)" value="Print">
					</div>
				</c:if>
									</div>
								</div>
